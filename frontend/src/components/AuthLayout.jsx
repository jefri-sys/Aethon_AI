...
function AuthLayout({ title, subtitle, children, footer }) {
  return (
    <div className="min-h-screen bg-neutral-950 flex items-center justify-center p-4 sm:p-8">
      <Card className="w-full max-w-[1200px] min-h-[600px] bg-black/[0.96] relative overflow-hidden border-neutral-800 shadow-2xl rounded-2xl">
        <Spotlight
        ...
        <div className="flex flex-col md:flex-row h-full min-h-[600px]">
          ...
          <div className="flex-1 p-8 md:p-12 lg:p-16 relative z-10 flex flex-col justify-center bg-transparent">
            <Link to="/" className="flex items-center gap-3 mb-10 text-white no-underline transition-opacity hover:opacity-80">
              <Brain className="text-neutral-300" size={32} />
