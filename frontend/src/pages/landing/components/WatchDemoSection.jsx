...
import { ArrowRight, Calendar, FileText, MessageSquare, DollarSign, Target, CheckSquare, BrainCircuit, BarChart2, Briefcase, FileSearch } from 'lucide-react';
...
const WatchDemoSection = ({ onWatchDemoClick }) => {
  ...
  return (
    <section id="demo" className="demo-section">
      <div className="demo-container demo-glass-panel">
        <div className="demo-left">
          <div style={{ animation: 'fadeIn 0.5s ease-out' }}>
            ...
            <ul className="demo-list">
              ...
              <li><Briefcase size={16}/> Career Vault</li>
              <li><FileSearch size={16}/> Smart Resume Creator</li>
